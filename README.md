```
 (c) 2016, Thuy Dang <write.thuy@gmail.com> 

 This file is a module for Ansible that manage kvm guests.
...
Table of Contents
=================
NOT VERSION CONTROLLED. CREATE A GITHUB REPO WHEN MATURE ENOUGH!!!!

  * [Table of Contents](#table-of-contents)
  * [This documentation is a work in progress.](#this-documentation-is-a-work-in-progress)
  * [Why did I write an Ansible module for KVM?](#why-did-i-write-an-ansible-module-for-kvm)
